...
?>
    ...
    $str.="<table class='table table-bordered'><tr><th> Name</th><th>Address</th></tr>";
        ...
        $qry = "SELECT fname,lname, houseno,blockname FROM member,house,block
                where lname like '$lname'and  house.houseid=member.houseid and block.blockid=house.blockid ";
...
Last Name  : <input type="text" class="form-control"  placeholder="Enter Last Name" name="txt1" >
